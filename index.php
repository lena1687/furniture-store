...
$APPLICATION->SetPageProperty("tags", "мебель");
$APPLICATION->SetPageProperty("keywords", "мебель");
$APPLICATION->SetPageProperty("description", "Мебель");

$APPLICATION->SetTitle("ВРК Мебель");?><?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	"slider1",
	Array(
...
<div class="offers-bg">
	<div class="container">
		<div class="why-we clearfix">
			<div class="romb">
			</div>
			<h2 class="why__we-title">
			<?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	".default",
	Array(
		"AREA_FILE_RECURSIVE" => "Y",
		"AREA_FILE_SHOW" => "file",
		"AREA_FILE_SUFFIX" => "offers",
		"COMPONENT_TEMPLATE" => ".default",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/offers_title.php"
	)
);?> </h2>
			<div class="why-we__block1">
				<div class="why__block-container cont-left">
					<div class="block-subtitle1">
						 <?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	".default",
	Array(
		"AREA_FILE_SHOW" => "file",
		"AREA_FILE_SUFFIX" => "subtitle_offers_list_1",
		"COMPONENT_TEMPLATE" => ".default",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/subtitle_offers_list_1.php"
	)
);?>
					</div>
					 <?$APPLICATION->IncludeComponent(
	...
	Array(
		"AREA_FILE_SHOW" => "file",
		"AREA_FILE_SUFFIX" => "offers_list_1",
		"COMPONENT_TEMPLATE" => "offers_left",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/offers_list_1.php"
	)
);?>
				</div>
				<div class="cont__left-desc">
					 <?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	"",
	Array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/left_desc.php"
	)
);?>
				</div>
			</div>
			<div class="why-we__block2">
				<div class="why__block-container cont-right">
	...
	Array(
		"AREA_FILE_SHOW" => "file",
		"AREA_FILE_SUFFIX" => "subtitle_offers_list_2",
		"COMPONENT_TEMPLATE" => ".default",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/subtitle_offers_list_2"
	)
);?>
					</div>
					 <?$APPLICATION->IncludeComponent(
	...
	Array(
		"AREA_FILE_SHOW" => "file",
		"AREA_FILE_SUFFIX" => "offers_list_2",
		"COMPONENT_TEMPLATE" => "offers_right",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/offers_list_2.php"
	)
);?>
				</div>
				<div class="cont__right-desc">
					 <?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	"",
	Array(
		...
		"AREA_FILE_SUFFIX" => "inc",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/right_desc.php"
	)
);?>
				</div>
			</div>
			<div class="why__we-desc">
				 <?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	".default",
	Array(
		"AREA_FILE_RECURSIVE" => "Y",
		"AREA_FILE_SHOW" => "file",
		"AREA_FILE_SUFFIX" => "offers_desc",
		"COMPONENT_TEMPLATE" => ".default",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/sect_offers_desc.php"
	)
);?>
			</div>
		</div>
	...
	<div class="features">
		<div class="row">
			<div class="col-12">
				...
				<h2>
				<?$APPLICATION->IncludeFile(
                        SITE_DIR."include/feature-title.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
		...
		<div class="row">
			<div class="col-12 col-md-8 offset-md-2">
				<div class="features-list">
					 <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/feature-list.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
...
<div class="problems">
    ...
    <h2>
        <?$APPLICATION->IncludeFile(
            SITE_DIR."include/problems-title.php",
            array(),
            array(
                "MORE" => "html"
            )
...
<div class="problem-bk-list">
    <div class="problems-list">
        <div class="problem-bk problem-1-bk">
            <div class="problems-text">
                <h6>
                    <?$APPLICATION->IncludeFile(
                    SITE_DIR."include/problems-1.php",
                    array(),
                    array(
                        "MORE" => "html"
                    )
                ...
                <h5>
                    <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/problems-1-s.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
        ...
        <div class="problem-bk problem-2-bk">
            <div class="problems-text">
                <h6>
                    <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/problems-2.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
                ...
                <h5>
                    <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/problems-2-s.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
        ...
        <div class="problem-bk problem-3-bk">
            <div class="problems-text">
                <h6>
                    <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/problems-3.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
                ...
                <h5>
                    <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/problems-3-s.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
        ...
        <div class="problem-bk problem-4-bk">
            <div class="problems-text">
                <h6>
                    <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/problems-4.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
                ...
                <h5>
                    <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/problems-4-s.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
        ...
        <div class="problem-bk problem-5-bk">
            <div class="problems-text">
                <h6>
                    <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/problems-5.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
                ...
                <h5>
                    <?$APPLICATION->IncludeFile(
                        SITE_DIR."include/problems-5-s.php",
                        array(),
                        array(
                            "MORE" => "html"
                        )
