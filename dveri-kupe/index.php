...
$APPLICATION->SetTitle("Двери-купе");?>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "slider_desc"
	),
	false
);?>
...
<div class="door-container container">
    <h1 class="materials-title"><?$APPLICATION->ShowTitle()?></h1>
    
	<div class="door-offers container">
        <?$APPLICATION->IncludeComponent(
            "bitrix:main.include",
            "",
            Array(
                "AREA_FILE_SHOW" => "page",
                "AREA_FILE_SUFFIX" => "/include/door_offers.php",
                "EDIT_TEMPLATE" => ""
            )
        );?>
	</div>
	...
	array(
		...
		"SORT_ORDER2" => "ASC",
		"STRICT_SECTION_CHECK" => "N",
		"COMPONENT_TEMPLATE" => "materials_table_door"
	),
	false
);?>
    <?$APPLICATION->IncludeFile(
        SITE_DIR."include/link-system.php",
        array(),
        array(
            "MORE" => "html"
        )
	...
	<div class="door-offers__bottom container">
        <?$APPLICATION->IncludeComponent(
            "bitrix:main.include",
            "",
            Array(
                "AREA_FILE_SHOW" => "page",
                "AREA_FILE_SUFFIX" => "/include/door_offers_bottom.php",
                "EDIT_TEMPLATE" => ""
            )
        );?>
	</div>
