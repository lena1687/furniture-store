...
$APPLICATION->SetTitle("Стекло с пленкой Oracal");
?>
	...
	array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/materials/3_materials_article.php",
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "materials_table_big_foto"
	),
	false
);?>
<?$APPLICATION->IncludeComponent(
